<section class="home-section">
    <div class="text">
        ...
        <div class="breadcrumb-item active" style="font-size: 1.3rem;">Reading Activity</div>
                ...
                @foreach ($activities as $activityId => $activity)
                    <div class="assignment-card activity-toggle" onclick="toggleActivityDetails('{{ $activityId }}')">
                        ...
                        <div class="activity-actions" style="margin-top: 10px; display: flex; gap: 10px;">
                            ...
                            <!-- Delete Button -->
                            <form action="{{ route('mio.subject-teacher.speech-phrase.delete', ['subjectId' => request()->route('subjectId'), 'difficulty' => $difficulty, 'activityId' => $activityId]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this activity?');" style="margin: 0;">
                                @csrf
                                @method('DELETE')
    ...
    <div id="addActivityModal" class="modal assignment-modal" style="display: none;">
        <div class="modal-content">
            ...
            <form action="{{ route('mio.subject-teacher.speech-phrase.add', ['subjectId' => request()->route('subjectId')]) }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <div id="editActivityModal" class="modal assignment-modal" style="display: none;">
        <div class="modal-content">
            ...
            <form id="editActivityForm" method="POST" action="{{ route('mio.subject-teacher.speech-phrase.edit', ['subjectId' => request()->route('subjectId')]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
